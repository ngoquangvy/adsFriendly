...
if (isPrefilledGoogleSearch) {
  document.getElementById("btn-whitelist").lastChild.textContent =
    " Open this search";
  document.getElementById("btn-blacklist").lastChild.textContent =
    " Keep blocked";
}
...
document.getElementById("btn-whitelist").onclick = () =>
  sendMessage("WHITELIST");
document.getElementById("btn-blacklist").onclick = () =>
